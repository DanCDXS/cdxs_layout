...
// Batman logo
void render_batman_logo(void) {
    static const char PROGMEM font_batman_logo[11] = {0xb5, 0xb6, 0xb7, 0xb8, 0xb9, 0xd5, 0xd6, 0xd7, 0xd8, 0xd9, 0};
    oled_write_P(font_batman_logo, false);
};
